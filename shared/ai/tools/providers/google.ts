 ...
 * Google Gemini Tools
 *
 * Tool definitions for Gemini models.
 *
 * @provider Google
 * @date 2026-01-25
 */
...
export type GeminiAgentId = "deepResearch";

export type GeminiToolInfo = BaseToolInfo<GeminiToolId | GeminiAgentId>;

export const GEMINI_TOOLS_INFO: Record<GeminiToolId, GeminiToolInfo> = {
    googleSearch: {
        id: "googleSearch",
        name: "Google Search",
...
export const GEMINI_AGENTS_INFO: Record<GeminiAgentId, GeminiToolInfo> = {
    deepResearch: {
        id: "deepResearch",
        name: "Deep Research",
